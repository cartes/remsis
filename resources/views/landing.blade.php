...
<head>
    ...
    <meta name="description"
        content="Software de remuneraciones para Chile. Gestiona sueldos, liquidaciones, cotizaciones previsionales (Previred) y contratos de forma 100% online y legal.">
    <meta name="keywords"
        content="remuneraciones, sueldos, liquidaciones de sueldo, previred, software recursos humanos, chile, pyme, contabilidad">
    <meta name="robots" content="index, follow">
    <meta name="author" content="REMSYS">
    <link rel="canonical" href="{{ request()->url() }}">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ request()->url() }}">
    <meta property="og:title" content="REMSYS - Gestión de Remuneraciones para Chile">
    <meta property="og:description"
        content="Automatiza el cálculo de sueldos, imposiciones y contratos. Cumple con la normativa de la Dirección del Trabajo y Previred.">
    <meta property="og:image" content="{{ asset('images/hero-dashboard.png') }}">
    <meta property="og:locale" content="es_CL">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ request()->url() }}">
    <meta property="twitter:title" content="REMSYS - Remuneraciones Simples para tu Empresa">
    <meta property="twitter:description"
        content="Calcula sueldos y cotizaciones en segundos. Prueba gratis sin tarjeta de crédito.">
    <meta property="twitter:image" content="{{ asset('images/hero-dashboard.png') }}">
            ...
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                <div class="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <p class="text-xl text-gray-600">
                        Olvídate de las planillas de cálculo complejas. REMSYS centraliza toda la información laboral en
                        un
                        solo lugar seguro.
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div
                        ...
                        <div class="p-8">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-6">
                                Calcula sueldos, gratificaciones, horas extras y bonos al instante. Olvídate de los
                                errores
                    ...
                    <div
                        ...
                        <div class="p-8">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-6">
                                Siempre actualizado con la normativa laboral chilena. Genera contratos, anexos y
                                finiquitos
                    ...
                    <div
                        ...
                        <div class="p-8">
                            ...
                            <p class="text-gray-600 leading-relaxed mb-6">
                                Genera el archivo de carga para Previred con un solo clic. Ahorra horas de trabajo
                                tedioso
