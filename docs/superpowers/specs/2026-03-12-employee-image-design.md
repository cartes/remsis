...
3. si existe archivo, borrar la foto previa del `User` en disco `public`;
4. guardar la nueva imagen en `profile-photos/` del disco `public`;
5. persistir la ruta en `users.profile_photo`;
...
8. El listado refleja la miniatura actualizada al cerrar o recargar la vista.
